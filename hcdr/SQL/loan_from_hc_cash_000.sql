...
,IFNULL(pa.amt_annuity, '0.0') as amt_annuity
,IFNULL(pa.amt_application, '0.0') as amt_application
,IFNULL(pa.amt_credit, '0.0') as amt_credit 
,IFNULL(pa.amt_down_payment, '0.0') as amt_down_payment
,IFNULL(pa.amt_goods_price, '0') as amt_goods_price
,pa.weekday_appr_process_start
,pa.hour_appr_process_start
,pa.flag_last_appl_per_contract
,pa.nflag_last_appl_in_day
,IFNULL(pa.rate_down_payment, '0.0') as rate_down_payment
,IFNULL(pa.rate_interest_primary, '0.0') as rate_interest_primary
,IFNULL(pa.rate_interest_privileged, '0.0') as rate_interest_privileged
